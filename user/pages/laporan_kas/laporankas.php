...
session_start();
include ('../../partials/config.php'); // Corrected path
      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-advanced">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="pages/ui-featuress/laporan-harian.php">Laporan Harian</a>
              </li>
              <li class="nav-item"> <a class="nav-link" href="pages/ui-featuress/laporan-bulanan.php">Laporan
                  Bulanan</a></li>
