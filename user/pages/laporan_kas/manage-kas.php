        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"><a class="nav-link" href="../../pages/ui-featuress/kegiatan.php">Jadwal Kegiatan</a>
              </li>
              <li class="nav-item"><a class="nav-link" href="../../pages/ui-featuress/manage-kegiatan.php">Kelola JadwalKegiatan</a>
            </li>
                            ...
                            <div class="card-body">
                                ...
                                <form action="" class="forms-sample" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputPassword4" name="pemasukan" placeholder="Pemasukan" value="<?php echo htmlspecialchars($pemasukan); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputCity1" name="penerima" placeholder="Penerima" value="<?php echo htmlspecialchars($penerima); ?>">
                                    </div>
